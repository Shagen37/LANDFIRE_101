...
4. The [rlandfire](https://github.com/bcknr/rlandfire) R package, by [Mark Buckner](https://github.com/bcknr) who is currently (as of January 2024) a PhD candidate at Cornell University. This package allows you to import LANDFIRE data directly into your R environment. To learn more about using the rlandfire package, check out the Office Hour “[LANDFIRE & Coding: Leveling up LANDFIRE with r markdown, QGIS, Quarto and More!](https://youtu.be/Go5foMcOG-c)".
