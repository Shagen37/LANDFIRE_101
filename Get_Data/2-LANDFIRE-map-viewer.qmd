...
*Screenshots of this process are provided below the written instructions for those who find them useful.*
...
::: callout-note
Not all datasets are available with every version. [Visit the LANDFIRE Program Website](https://landfire.gov/data#versions) to begin learning about versions.
:::
...
![Where to find the LANDFIRE Map Viewer - on the individual product pages](images/LFMV_product-page.bmp){fig-alt="Location of the LANDFIRE Map Viewer on the individual product pages of the LANDFIRE Program Website. An arrow points to the LANDFIRE Map Viewer link under the Data Access section of the page."}
