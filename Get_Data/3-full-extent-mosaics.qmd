...
💡 *Note: Screenshots are provided below for those who find them useful*
...
![From the Learn More button under the Data heading on the main page of the LANDFIRE Program website](images/get-data.bmp){fig-alt="The main page of the LANDFIRE Program website. An arrow points to the Learn More button under the Data heading - the middle of three boxes across the main section of the page."}
