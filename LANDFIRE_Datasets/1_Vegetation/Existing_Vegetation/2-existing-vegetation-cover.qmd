...
We often use LANDFIRE EVC in combination with EVT and Existing Vegetation Height (EVT) to better understand landscapes using something we call landscape assessments. We will have a later section of this website specifically dedicated to how we create landscape assessments using GIS and R.
